...
export const routes: Routes = [
  ...
  { path: 'listap', component: ListPrespComponent, canActivate: [PermissionGuard], data: { permissions: ['VIEW_PRESUPUESTO'] } },
  { path: 'revolvente', component: GastoRevComponent, canActivate: [PermissionGuard], data: { permissions: ['CREATE_GASTO_REV'] } },
  { path: 'view-gastos', component: ViewGastosComponent, canActivate: [PermissionGuard], data: { permissions: ['VIEW_GASTO'] } },
  { path: 'auth-gastos', component: AuthGastosComponent, canActivate: [PermissionGuard], data: { permissions: ['UPDATE_GASTO'] } },
  { path: 'captura-gastos', component: CapGastosComponent, canActivate: [PermissionGuard], data: { permissions: ['CREATE_GASTO'] } },
  { path: 'edit', component: EditGastoComponent, canActivate: [PermissionGuard], data: { permissions: ['UPDATE_GASTO'] } },
  { path: 'captura-cheque', component: CapChequeComponent, canActivate: [PermissionGuard], data: { permissions: ['CREATE_CHEQUE'] } },
  { path: 'captura-transfer', component: CapTransferComponent, canActivate: [PermissionGuard], data: { permissions: ['CREATE_TRANSACCION'] } },
  { path: 'transfer', component: TransferComponent, canActivate: [PermissionGuard], data: { permissions: ['VIEW_TRANSACCION'] } },
  { path: 'registro-sucursal', component: RegisterSucursalComponent, canActivate: [PermissionGuard], data: { permissions: ['CREATE_SUCURSAL'] } },
  { path: 'registro-provedor', component: RegisterProvedorComponent, canActivate: [PermissionGuard], data: { permissions: ['CREATE_PROVEEDOR'] } },
  { path: 'ventas', component: DepComprasComponent },
  { path: 'create', component: NewPresupuestoComponent, canActivate: [PermissionGuard], data: { permissions: ['CREATE_PRESUPUESTO'] } },
  { path: 'asignacion', component: AsignacionPresupuestoComponent, canActivate: [PermissionGuard], data: { permissions: ['CREATE_ASIGNACION'] } },
  { path: 'presupuesto', component: PresupuestoComponent, canActivate: [PermissionGuard], data: { permissions: ['VIEW_PRESUPUESTO'] } },
  { path: 'solicitud', component: SolicitudGastoComponent, canActivate: [PermissionGuard], data: { permissions: ['CREATE_SOLICITUD'] } },
  { path: 'registro-empleado', component: RegEmpleadoComponent, canActivate: [PermissionGuard], data: { permissions: ['VIEW_EMPLEADO'] } },
  { path: 'gastos-comprobados', component: GastCompComponent, canActivate: [PermissionGuard], data: { permissions: ['VIEW_GASTO'] } },
  { path: 'gastos-recurrentes', component: GastosRevolventesComponent, canActivate: [PermissionGuard], data: { permissions: ['VIEW_GASTO_REV'] } },
  { path: 'contratista', component: CaptContraComponent, canActivate: [PermissionGuard], data: { permissions: ['CREATE_CONTRATO'] } },
  { path: 'detalleFex', component: DetalleEfexComponent, canActivate: [PermissionGuard], data: { permissions: ['VIEW_EFECTIVO'] } },
  { path: 'contabilidad', component: ContabilidadComponent, canActivate: [PermissionGuard], data: { permissions: ['VIEW_CONTABILIDAD'] } },
  ...
  { path: 'tesoreria', component: TesoreriaComponent, canActivate: [PermissionGuard], data: { permissions: ['VIEW_GASTO'] } },
  { path: 'liberacion', component: AuthTesoreriaComponent, canActivate: [PermissionGuard], data: { permissions: ['UPDATE_GASTO'] } },
