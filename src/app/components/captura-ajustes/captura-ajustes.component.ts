...
import { SucursalService } from '../../services/branch.service';
import {
  Area,
  Cheque,
  Concept,
...
import { CapGastos } from '../../services/cap-gastos.service';
import { timeout } from 'rxjs';
import { CapChequeService } from '../../services/cap-cheque.service';
...
export class CapturaAjustesComponent implements OnInit {
  ...
  usuario = new FormGroup({
    usuario: new FormControl(
      localStorage.getItem('usuario') || localStorage.getItem('usuario')
    ),
  });
